...
//Snapchat != Snapshot
//Snapshot = Latest state of the database is Snapshot
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* { <button
          onClick={handleFetch}
          className="block mx-auto mb-8 bg-blue-600 text-white px-6 py-2 rounded-lg shadow hover:bg-blue-700 transition-all"
        >
          Get Products
        </button> } */}
      ...
      <button className="bg-amber-600 text-white p-4 font-medium" onClick={(e)=>{router.push("/create-product")}}>Back</button>
    </div>
  );
}